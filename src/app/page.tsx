                  ...
                  <div className="space-y-4">
                    ...
                    {selectedPaymentMethod === 'paynow' && (
                      <div className="bg-blue-50 p-4 rounded-lg text-center">
                        <p className="text-sm text-gray-600 mb-3">Scan this QR code with your banking app</p>
                        <div className="flex justify-center">
                          <div className="w-48 h-48 bg-white border-2 border-purple-500 rounded-lg flex items-center justify-center">
                            <div className="text-center p-4">
                              <div className="text-purple-600 font-bold text-lg mb-2">PAYNOW</div>
                              <div className="text-xs text-gray-600 mb-2">Scan with your banking app</div>
                              <div className="w-32 h-32 mx-auto bg-gray-800 rounded-lg flex items-center justify-center">
                                <div className="text-white text-2xl">QR</div>
                              </div>
                              <div className="text-xs text-gray-500 mt-2">Total: S${getTotalPrice()}</div>
                            </div>
                          </div>
                        </div>
                      </div>
